<template>
  ...
  <div class="bg-white pb-6 sm:pb-8 lg:pb-12">
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
      <header
        class="flex justify-between items-center py-4 md:py-8 mb-8 md:mb-12 xl:mb-16"
      >
        <!-- logo - start -->
        <a
          href="/"
  ...
  <div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
      ...
      <div
        class="sm:h-40 grid grid-cols-2 md:grid-cols-4 sm:content-evenly bg-gray-100 rounded-lg gap-6 p-6"
      >
        <!-- logo - start -->
    ...
    <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 md:divide-x gap-8 md:gap-0">
        ...
        <div class="flex flex-col items-center md:p-4">
          <div
            class="text-indigo-500 text-xl sm:text-2xl md:text-3xl font-bold"
          >
            200
          </div>
  ...
  <div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="max-w-screen-xl px-4 md:px-8 mx-auto">
      ...
      <div
        class="grid sm:grid-cols-2 lg:grid-cols-3 gap-y-10 sm:gap-y-12 lg:divide-x"
      >
        <!-- quote - start -->
        <div class="flex flex-col items-center gap-4 md:gap-6 sm:px-4 lg:px-8">
          ...
          <div class="flex flex-col sm:flex-row items-center gap-2 md:gap-3">
            <div
              class="w-12 md:w-14 h-12 md:h-14 bg-gray-100 rounded-full overflow-hidden shadow-lg"
            >
              <img
            ...
            <div>
              <div
                class="text-indigo-500 text-sm md:text-base font-bold text-center sm:text-left"
              >
                John McCulling
              </div>
              <p
                class="text-gray-500 text-sm md:text-sm text-center sm:text-left"
              >
                CEO / Datadrift
              </p>
            </div>
    ...
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
      <div class="flex flex-col items-center bg-gray-100 rounded-lg p-4 sm:p-8">
        <div class="mb-4 sm:mb-8">
          <h2
            class="text-indigo-500 text-xl sm:text-2xl lg:text-3xl font-bold text-center"
          >
  ...
  <div class="bg-gray-900">
    <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto">
      ...
      <div
        class="text-gray-400 text-sm text-center border-t border-gray-800 py-8"
      >
