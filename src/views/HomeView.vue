<template>
  <div class="relative">
    <div
      class="absolute top-24 left-24 z-10 w-60 h-60 bg-purple-400 rounded-full mix-blend-multiply filter blur-xl opacity-70"
    ></div>
    <div
      class="absolute top-10 right-24 z-10 w-80 h-80 bg-pink-400 rounded-full mix-blend-multiply filter blur-xl opacity-70"
    ></div>

    <div
      class="absolute bottom-0 left-1/2 z-10 w-60 h-60 bg-indigo-400 rounded-full mix-blend-multiply filter blur-xl opacity-70"
    ></div>
      ...
      <div class="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
        <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div class="sm:max-w-lg">
            ...
            >
              <span class="block xl:inline dark:text-gray-100">Hi, I'm</span>
              {{ " " }}
            ...
            >
              <div class="rounded-md shadow">
                <router-link
                  to="/projects"
                  class="hover:animate-pulse flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 md:py-4 md:px-10 md:text-lg"
